...
// AddImageToProfile mocks base method
func (m *MockUseCase) AddImageToProfile(arg0 int, arg1 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddImageToProfile", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// AddImageToProfile indicates an expected call of AddImageToProfile
func (mr *MockUseCaseMockRecorder) AddImageToProfile(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddImageToProfile", reflect.TypeOf((*MockUseCase)(nil).AddImageToProfile), arg0, arg1)
}
